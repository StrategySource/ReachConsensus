  ...
  return (
    <div className="grid gap-4">
      {proposals.map((proposal) => {
        const hasPublishedMicrosite = proposal.publishedVersions.length > 0;
          ...
          <article key={proposal.id} className="rounded-lg border border-[#d9e0e8] bg-white p-5 shadow-sm">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-3 text-sm font-semibold text-[#657180]">
              ...
              {hasPublishedMicrosite ? (
                ...
                <span className="rounded-md border border-[#d9e0e8] bg-[#f7f9fc] px-3 py-2 font-bold text-[#657180]">
